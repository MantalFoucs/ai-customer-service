      ...
      <div className="flex justify-end">
        <div className="max-w-[80%]">
          <div className="relative">
            <div 
              className="px-4 py-3 rounded-2xl rounded-tr-sm shadow-md"
              style={{
            ...
            >
              ...
              {message.content && <p className="text-sm text-white/95 whitespace-pre-wrap leading-relaxed">{message.content}</p>}
            </div>
            <div className="absolute -right-1 top-0 w-3 h-3 bg-gradient-to-br from-teal-500 to-emerald-500 rounded-full opacity-60"></div>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-[85%]">
        <div className="flex items-start gap-3 mb-2">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs text-gray-500 font-semibold">群接龙 AI</span>
          </div>
        </div>
        ...
        {message.logistics ? (
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-2xl rounded-bl-md px-4 py-3 shadow-card border border-white/50">
